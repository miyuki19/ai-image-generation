...
import { generateImageFromPrompt, createAPost } from '../services/postServices'
...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    ...
    generateImageFromPrompt(form.prompt)
      .then((data) => {
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-400
          w-64 p-3 h-63 flex justify-center items-center"
          >
            {form.photo ? (
              <img
                src={form.photo}
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e74] text-[14px]">
